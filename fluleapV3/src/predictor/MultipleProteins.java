...
/**
 * Servlet implementation class MultipleProteins
 */
@WebServlet("/multiple-proteins")
public class MultipleProteins extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public MultipleProteins() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request,
		...
		out.println("<br><p>\n"
				+ "<form action=\"multiple-proteins-results\" method=\"post\">\n"
				+ "<table>\n"
	...
	private String getBodyContent() {
		return ("<div id=\"main\">\n"
				...
				+ "<div class=\"12u\">\n"
				+ "<section>\n"
				+ "<h2>Multiple proteins predictors</h2>\n"
				+ "<p>Predictors for multiple influenza proteins including glycoproteins HA and NA, nucleoprotein NP, both matrix proteins M1 and M2, both non-structural proteins NS1 and NS2, as well as the rest of the viral polymerase proteins PA, PB1, PB1-F2, and PB2.</p>\n"
				+ "<a href=\"tutorial.html\" class=\"button\">Tutorial</a>\n"
				+ "<a href=\"strain-example\" class=\"button\">Example</a></p>\n"
                + "<p><strong>Please input protein sequence for prediction in the text box below. Only input sequence for which prediction is to be made, input for the remaining proteins are not required.</p>\n"
